...
- (NSArray *)arrayWithPinYinFirstLetterFormat
{
    ...
    for (cityModel *model in self) {
        NSString *firstLetter = [model.ciName getFirstLetter];
    ...
    for (int i = 'A'; i <= 'Z'; i++) {
        NSString *firstLetter = [NSString stringWithCString:(const char *)&i encoding:NSUTF8StringEncoding];
        NSMutableArray *array = dict[firstLetter];
        if ([array count]) {
            [array sortUsingComparator:^NSComparisonResult(id obj1, id obj2) {
                cityModel * model1 = obj1;
                cityModel * model2 = obj2;
                NSString *word1 = model1.ciName;
                NSString *word2 = model2.ciName;
