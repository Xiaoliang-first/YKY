...
- (void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (oneClick == NO) {
        [[NSNotificationCenter defaultCenter] postNotificationName:@"qiandao" object:nil];
        oneClick = YES;
    }else{
        ...
        NSString * last = [[NSUserDefaults standardUserDefaults]objectForKey:@"registOK"];
