...
+ (instancetype)cycleScrollViewWithFrame:(CGRect)frame imageURLsGroup:(NSMutableArray *)imageURLsGroup
{
    
    SDCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
    cycleScrollView.imageURLsGroup = [NSMutableArray arrayWithArray:imageURLsGroup];
    [imageURLsGroup removeAllObjects];
    [cycleScrollView.mainView reloadData];
    return cycleScrollView;
}
...
//    pageControl.dotColor = [UIColor greenColor];
